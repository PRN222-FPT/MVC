...
- Test components isolation: unit test ServiceLayer logic, integration test MVC endpoints and middleware.
...
Run `dotnet build GROUP1_Ass1.slnx` and `dotnet test GROUP1_Ass1.slnx`. Run Playwright browser install before UI tests when needed.
