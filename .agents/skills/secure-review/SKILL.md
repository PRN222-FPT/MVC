---
name: secure-review
description: Review 3-layer ASP.NET Core MVC changes for security, privacy, and secret-handling issues. Use before handoff or when touching Identity, authentication, authorization, EF Core queries, forms, logging, configuration, cookies, redirects, or user data.
---
